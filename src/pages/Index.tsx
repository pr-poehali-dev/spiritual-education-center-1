...
const SCHEDULE = [
  { day: "Воскресенье", items: ["09:00 — Воскресная школа (дети 5–10 лет)", "11:00 — Воскресная школа (дети 11–16 лет)", "13:00 — Беседа со священником", "15:00 — Хоровое пение"] },
  { day: "Понедельник", items: ["16:00 — Столярное дело", "17:00 — Рукопашный бой", "18:30 — Оздоровительная физкультура"] },
  { day: "Среда", items: ["15:00 — Живопись (дети)", "16:30 — Иконопись (взрослые)", "18:00 — Швейное мастерство"] },
  { day: "Пятница", items: ["16:00 — Самбо", "17:30 — Музыка", "19:00 — Лекция / открытая беседа"] },
];
